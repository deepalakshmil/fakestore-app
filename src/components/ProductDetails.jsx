    ...
    return (
        <div>
            <Container className="mt-5 pt-5">
                {success && <Alert variant="success" dismissible>"Hi" {success}</Alert>}
                    ...
                    <Col>
                        <Card className={styles.productstyle}>
                            ...
                            <Card.Body className="text-center">
                                ...
                                <Link className="custom-button" to="https://demo.snipcart.com/" target="_blank" width={500} >Add to Cart</Link>
                            </Card.Body>
                            <Card.Body>
                                <div className="d-grid gap-2">
                                    <Button variant="info" size="lg" active name="update" onClick={handleSubmit} className="fw-bold p-3">Update</Button>
                                    <Button variant="danger" size="lg" active className="fw-bold" type="submit" onClick={handleShow}>Delete</Button>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
                ...
                <div>
                    <Modal show={show} onHide={handleClose}>
                        ...
                        <Modal.Body>Are you want to Delete the product information to clik the conform button!</Modal.Body>
                        <Modal.Footer>
